...
void ZorkUL::goTeleport()
{
   ...
   /* const char* arrayRooms[10] = {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j"};
    std::string str(arrayRooms[9]);

    int RandIndex = rand() % 10;
    string intStr;
    intStr.push_back((char)RandIndex);


    const char* teleportedRoom = arrayRooms[RandIndex];
    cout << "You are now in room " << teleportedRoom << endl;

    Room* nextRoom = teleportedRoom;
    teleportedRoom = nextRoom;
...
/*string ZorkUL::teleport(string teleportedRoom)
{
    Room* newRoom = teleportedRoom;
